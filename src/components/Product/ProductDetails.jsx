        ...
        <div>
          <div className=" text-slate-300 pt-[20px] bg-slate-800">
            <div className="flex md:flex-row flex-col md:w-11/12 md:gap-x-12 md:mx-auto">
              <div className="md:w-1/2 w-full">
                <div className="px-8 ml-8 -z-10">
                  <Carousel className="">
                    {productData?.images?.map((item, i) => (
                      <div className="px-8 rounded-lg">
                        <img
                          className="object-fill  md:h-[500px] md:w-[400px] shadow-sm shadow-slate-400 w-[700px] h-[500px] -z-10"
                          key={item?.url}
                          src={item?.url}
                          alt={`${i}Slide`}
                        />
              ...
              <div className="flex flex-col items-center justify-center gap-y-2 w-50%">
                ...
                <div className="flex flex-col items-center justify-center gap-y-3">
                  ...
                  <div className="flex md:flex-row justify-center items-center md:gap-x-4 flex-col gap-y-3">
                    <div className="flex flex-row justify-center items-center ">
                      <button
                        className="h-8 bg-slate-300 text-slate-800 w-10  text-4xl  text-center"
                      ...
                      <input
                        readOnly
                        value={quantity}
                        className="w-[40px] bg-slate-200 text-2xl  text-slate-900 text-center"
                      />
                      <button
                        className="h-8 bg-slate-300 text-slate-800 w-8  flex items-center text-4xl justify-center"
                    ...
                    <button
                      ...
                      className="bg-orange-600 rounded-full w-[100px] hover:transition-all duration-75 delay-75 ease-out h-8 hover:bg-orange-800"
                ...
                <button
                  ...
                  className="bg-orange-600 rounded-full w-[150px] hover:transition-all  ease-out h-8 hover:scale-105 transition-all duration-75 delay-75 "
                >
                  Submit Review
                </button>
              </div>
          ...
          <div className="flex items-center justify-center">
            ...
            >
              ...
              <DialogActions>
                <Button onClick={submitReviewToggle} className="text-red-700">
                  Cancel
                </Button>
            ...
            <div className="w-[30vw] h-[1px] bg-slate-300 mt-2"></div>
          </div>
          ...
          {productData?.reviews && productData?.reviews[0] ? (
            ...
            <p className="text-center text-3xl text-slate-400 mt-5">
              No Reviews Yet
            </p>
          )}
        </div>
